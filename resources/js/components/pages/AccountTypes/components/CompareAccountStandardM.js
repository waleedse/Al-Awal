...
class CompareAccountStandardM extends Component {
    render() {
        return (
           ...
           {/* <div className="col-4 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorMobText"> Execution in under 0.1 second</h2>
              ...
              <button onClick={()=>{ window.open('https://my.alawalmarkets.com/en/register','_self')}} className="btnPrimaryPink2 pl-2 pr-2 mr-0 mt-4 mb-5">
                GET STARTED
              </button>
              </div> */}
           ...
           <div className="col-4 px-0 standardM compareAccountDetail">
               <div className="compareAccountBgM borderRightBlack">
               <h4 className="compareAccountInfoTitle text-black ">Cent</h4>
               <p className="compareAccountPrice text-black">$10/min</p>
           ...
           <div className="col-4 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorMobText"> 100</h2>
              ...
              <button onClick={()=>{ window.open('https://my.alawalmarkets.com/en/register','_self')}} className="btnPrimaryPink2  mt-4  ">
                GET STARTED
              </button>
              ...
              <div className="col-4 px-0 standardM compareAccountDetail">
               <div className="compareAccountBgM ">
