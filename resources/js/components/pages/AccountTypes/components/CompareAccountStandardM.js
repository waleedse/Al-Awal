           ...
           {/* <div className="col-4 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorMobText"> Execution in under 0.1 second</h2>
              ...
              <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="btnPrimaryPink2 pl-2 pr-2 mr-0 mt-4 mb-5">
                GET STARTED
              </button>
              </div> */}
           ...
           <div className="col-4 px-0 standardM compareAccountDetail">
            ...
            <h2 className="compareAccountNorMobText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorMobText"> 100</h2>
              ...
              <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="btnPrimaryPink2  mt-4  ">
                GET STARTED
              </button>
