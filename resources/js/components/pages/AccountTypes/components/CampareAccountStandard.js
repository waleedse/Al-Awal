      ...
      <>
        {/* <div className="col-md-4 col-sm-12 px-0">
          ...
          <div className="compareAccountActions">
              ...
              <div className="compareAccountActionRow">
                ...
                <div onClick={()=>{ window.open('https://client.alawalcapital.co.uk/#/auth/signup','_self')}} className="compareAccountActionButton">Demo</div>
              </div>
            </div>
            ...
            <p className="compareAccountText mt-4">RECOMMENDED FOR:</p>
              ...
              <div className="text-center">
                <button onClick={()=>{ window.open('https://client.alawalcapital.co.uk/#/auth/signup','_self')}} className="compareAccountButton">
                  Open Micro Account
                </button>
              </div>
            </div>
            <div className="compareAccountDetail">
            <h4 className="title2_ d-inine "><span className="opacityZero">CURRENCY</span></h4>
            <h2 className="compareAccountNorText mt-3">USD</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">Spread</span></h4>
              <p className="compareAccountNorText">Spread: From 2.5</p>
              <h4 className="title2_ d-inine "><span className="opacityZero">Commission Markup</span></h4>
              <h2 className="compareAccountNorText"> NIl</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">Minimum Deposit</span></h4>
              <h2 className="compareAccountNorText"> $10</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">Leverage</span></h4>
              <h2 className="compareAccountNorText"> Up to 1:500 for currencies</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">Instruments</span></h4>
             <h2 className="compareAccountNorText">  Majors, Minors, Spot Metals - 2, Spot Energy - 2, US30, GER30</h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">SWAP</span></h4>
             <h2 className="compareAccountNorText"> <p className="text">Swap Free</p></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">OVERNIGHT COMMISSIONS</span></h4>
             <h2 className="compareAccountNorText"> <p className="text">No Commision</p></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">PRECISION</span></h4>
             <h2 className="compareAccountNorText"> 5 decimals for FX (3
                on JPY pairs), <br/> Spot Metals: 2 decimals for XAUUSD and 3 decimals
                for XAGUSD</h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">MARGIN CALL/STOP OUT LEVEL</span></h4>
             <h2 className="compareAccountNorText"> 80% / 50%</h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">HeDGING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">SCALPING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">EXPERT ADVISOR</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">EXECUTION TIME</span></h4>
             <h2 className="compareAccountNorText"> Execution in under 0.1 second</h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">MAXIMUM ORDERS</span></h4>
             <h2 className="compareAccountNorText"> Execution in under 0.1 second</h2>
        ...
        <div className="col-md-6 col-sm-12 px-0">
          ...
          <div className="compareAccountActions ">
            ...
            <h2 className="compareAccountNorText mt-3">USD</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">SPREAD</span></h4>
              <p className="compareAccountNorText">Spread: From 1.8</p>
              <h4 className="title2_ d-inine "><span className="opacityZero">COMMISION/MARKUP </span></h4>
              <h2 className="compareAccountNorText"> NIl</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">MINIMUM DEPOSIT</span></h4>
              <h2 className="compareAccountNorText"> $10</h2>
              <h4 className="title2_ d-inine "><span className="opacityZero">LEVERAGE</span></h4>
             ...
             <h2 className="compareAccountNorText"> 5 decimals for FX (3
                ...
                for XAGUSD</h2>
             <h4 className="title2_ d-inine "> <span className="opacityZero"> MARGIN CALL/STOP OUT LEVEL </span></h4>
             <h2 className="compareAccountNorText"> 50% / 20%</h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">HeDGING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="opacityZero">SCALPING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             ...
             <h4 className="title2_ d-inine "> <span className="opacityZero">IB Rebate</span></h4>
        ...
        <div className="col-md-6 col-sm-12 px-0">
          ...
          <div className="compareAccountActions compareAccountBg1">
            ...
            <div className="compareAccountDetail">
            <h4 className="title2_ d-inine "><span className="">CURRENCY</span></h4>
            <h2 className="compareAccountNorText mt-3">USD</h2>
              <h4 className="title2_ d-inine "><span className="">Spread</span></h4>
              <p className="compareAccountNorText">Spread: From 1.5</p>
              <h4 className="title2_ d-inine "><span className="">Commission Markup</span></h4>
              <h2 className="compareAccountNorText"> NIl</h2>
              <h4 className="title2_ d-inine "><span className="">Minimum Deposit</span></h4>
              <h2 className="compareAccountNorText"> $50</h2>
              <h4 className="title2_ d-inine "><span className="">Leverage</span></h4>
              <h2 className="compareAccountNorText"> Up to 1:500 for currencies</h2>
              <h4 className="title2_ d-inine "><span className="">Instruments</span></h4>
             <h2 className="compareAccountNorText">  Majors, Minors, Spot Metals - 2, Spot Energy - 2, US30, Dax 30</h2>
             <h4 className="title2_ d-inine "><span className="">SWAP</span></h4>
             <h2 className="compareAccountNorText"> <p className="text">Swap Free</p></h2>
             <h4 className="title2_ d-inine "><span className="">OVERNIGHT COMMISSIONS</span></h4>
             <h2 className="compareAccountNorText"> <p className="text">No Commision</p></h2>
             <h4 className="title2_ d-inine "><span className="">PRECISION</span></h4>
             <h2 className="compareAccountNorText"> 5 decimals for FX (3
                on JPY pairs), <br/> Spot Metals: 2 decimals for XAUUSD and 3 decimals
                for XAGUSD</h2>
             <h4 className="title2_ d-inine "><span className="">MARGIN CALL/STOP OUT LEVEL</span></h4>
             <h2 className="compareAccountNorText"> 50% / 20%</h2>
             <h4 className="title2_ d-inine "><span className="">HeDGING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="">SCALPING</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="">EXPERT ADVISOR</span></h4>
             <h2 className="compareAccountNorText"> <i className="fas fa-check text-success"></i></h2>
             <h4 className="title2_ d-inine "><span className="">EXECUTION TIME</span></h4>
             <h2 className="compareAccountNorText"> Execution in under 0.1 second</h2>
             <h4 className="title2_ d-inine "><span className="">MAXIMUM ORDERS</span></h4>
             <h2 className="compareAccountNorText">100</h2>
             <h4 className="title2_ d-inine "><span className="">IB Rebate</span></h4>
