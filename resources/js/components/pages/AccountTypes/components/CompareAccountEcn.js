        ...
        <div className="col-md-4 col-sm-12 px-0">
          ...
          <div className="compareAccountActions">
              ...
              <div className="compareAccountActionRow">
                <div onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="compareAccountActionButton border-none">
                  LIVE
                </div>
                <div onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="compareAccountActionButton">Demo</div>
              </div>
            </div>
            ...
            <p className="compareAccountText mt-4">RECOMMENDED FOR:</p>
              ...
              <div className="text-center">
                <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="compareAccountButton">
            ...
            <h2 className="compareAccountNorText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorText"> From $2 to $4</h2>
              <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="btnPrimaryPink2 pl-4 pr-4 mt-4 mb-5 mr-0">
                GET STARTED
              </button>
            </div>
          </div>
          ...
          <div className="compareAccountActions compareAccountBg3">
            ...
            <h2 className="compareAccountNorText mt-3">USD</h2>
             ...
             <h2 className="compareAccountNorText"> No Comission</h2>
              <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="btnPrimaryPink2 pl-4 pr-4 mt-4 mb-5 ">
                GET STARTED
              </button>
            </div>
          </div>
