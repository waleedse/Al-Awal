    ...
    render() {
        ...
        />
                ...
                <div className="row mt-4 mb-4">
                    ...
                    The primary concern among online traders is the safety of their funds. Al Awal Capital considers the security of customer funds to be the bedrock of the company’s values and no effort is spared in maintaining the security of customer funds and the integrity of our trading platforms.
                    </h4>
                    </div>
                ...
                <div className="basicRow  text-center">
                    <h2 className="aboutDetailTitle" style={{fontSize:'38px'}}>
                    Here’s how Al Awal Capital keeps your information and money secure:
...
Al Awal Capital is WebTrust compliant, as determined by the American Institute of Certified Public Accountants
<br/><br/>
Al Awal Capital uses McAfee Secure (HackerSafe) to prevent credit card fraud and identity theft
<br/><br/>
