...
const SwapAccount=()=>{
    ...
    <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="createBtn mt-2" >Register</button>  </>
}
const LowSpread=()=>{
    return <>  <div className="text px-4">Our Spreads are lowest in the market</div>

    <button onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} onClick={()=>{ window.open('https://my.alawalmarkets.net/register','_self')}} className="createBtn mt-2" >Register</button>  </>
}
const FastDeposite=()=>{
